...
void loadConfig(Config& config, char* configFile) {
    ...
    while (getline(fin, line)) {
        ...
        else if (line.find("tmpType3") != string::npos)
            iss >> config.tmpType3;
        else if (line.find("tmpType4") != string::npos)
            iss >> config.tmpType4;
        else if (line.find("tmpType5") != string::npos)
            iss >> config.tmpType5;
        else if (line.find("tmpType ") != string::npos)
            iss >> config.tmpType;
        else if (line.find("doSimple ") != string::npos)
            iss >> config.doSimple;
